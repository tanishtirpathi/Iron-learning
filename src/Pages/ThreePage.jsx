...
function Thirdpage() {
  ...
  className="overflow-x-hidden w-screen py-10 flex flex-col lg:flex-row items-center px-6 sm:px-12 gap-y-10 lg:gap-x-12 bg-[#f2f6ff]"
>
  <div className="max-w">
  ...
  <div className="flex rounded-md px-6 py-5 space-y-4 shadow-md">
    <Terminal className="w-114 h-80">
      <TypingAnimation as={AnimatedSpan}>Jarvis intiatlising !</TypingAnimation>
      <TypingAnimation as={AnimatedSpan}>Geting the data from the interenet</TypingAnimation>
      <TypingAnimation as={AnimatedSpan}>welcome back Tanish sir</TypingAnimation>
      <TypingAnimation as={AnimatedSpan}>yes sir now I am ready to work</TypingAnimation>
      <TypingAnimation as={AnimatedSpan}>weather:- cloudy , 24 degree temperature</TypingAnimation>

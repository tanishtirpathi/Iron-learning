...
function App() {
  return (
    <>
     <Navbar />
<div className="overflow-x-hidden w-screen min-h-screen bg-white flex flex-col lg:flex-row justify-center items-center px-6 lg:px-12 gap-y-8 lg:gap-x-12 py-10">
  {/* Left section */}
  <RetroGrid />
  ...
  {/* Right section */}
  <div className="flex flex-col justify-center items-center bg-[#BCBCBC] rounded-md px-6 py-5 space-y-4 shadow-md w-full max-w-xs">
    <input
      className="bg-white text-[#101828] px-3 py-2 rounded w-full border"
      type="text"
